...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
  tools: [
    ...
    },
    {
      ...
      description: 'Get WiFi channel information for all interfaces with frequency-based band detection (wifi0: 2.4GHz, wifi1: 5GHz, wifi2: 5GHz/6GHz based on MHz)',
      inputSchema: {
        type: 'object',
        properties: {},
        required: []
    ...
    {
      name: 'getWlanScheduler',
      description: 'Get WLAN scheduler configuration showing weekly operating hours for all WLANs (hex-decoded: F=fully on, 0=off, per 15-min quarter)',
      inputSchema: {
        type: 'object',
        properties: {},
        required: []
